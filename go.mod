...
replace (
	...
	github.com/prometheus/prometheus => github.com/Invoca/prometheus v1.8.2-0.20260922220635-1480a8692939
	...
	// Patched for Prometheus 3.13 BucketQuantile / histogram_quantile annotation API.
	// Drop once upstream promql-engine catches up.
	github.com/thanos-io/promql-engine => ./internal/promql-engine
